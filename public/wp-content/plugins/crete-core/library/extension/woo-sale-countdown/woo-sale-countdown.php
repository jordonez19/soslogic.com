...
if ( ! class_exists( 'XPSC_Woo_Sale_Countdown' ) ) :
	...
	class XPSC_Woo_Sale_Countdown {
		...
		public function frontend_enqueue_global() {
			...
			wp_register_script( XPSC_PREFIX . '_actions', XPSC_ASSETS_URL . '/js/actions.js', array( 'jquery', 'flipclock' ), XPSC_VERSION, true );
		...
		public function sale_countdown() {
			...
			?>
				<h5 class="crete-sale-countdown-title"><?php echo esc_html( cs_get_option( 'countdown_ttl' ) ); ?></h5>
			<?php
...
<div class="crete-timer-for-countdown crete-timer-<?php echo cs_get_option('count_style');?> <?php echo cs_get_option('sdw_enable');?>">
		<div id="cretetimer"><?php echo $sale_to_date; ?></div>
		</div>
