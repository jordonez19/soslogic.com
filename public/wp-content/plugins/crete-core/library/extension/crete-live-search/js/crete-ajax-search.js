(function($){
    ...
    function productSearch(form,query,currentQuery,timeout){
        ...
        form.next('.search-results').html('').removeClass('active');
         $( ".crete-ajax-s-offcanvas" ).removeClass( "offcanvas-full-height" );
                        ...
                        success: function(data) {
                            ...
                            if (!form.next('.search-results').hasClass('empty')) {
                                ...
                                if (data.length) {
                                    ...
                                    $( ".crete-ajax-s-offcanvas" ).addClass( "offcanvas-full-height" );
                                    
                                } else {
                                    form.next('.search-results').html('<div class="crete-ajax-not-found">'+opt.noResults+'</div>').addClass('active');
