...
CSF::createWidget( 'crete_post_cat_widget', array(
    'title'       => 'Crete Post Category',
    'classname'   => 'crete-post-category',
...
//
if( ! function_exists( 'crete_post_cat_widget' ) ) {
    function crete_post_cat_widget( $args, $instance ) {
