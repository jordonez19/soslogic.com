...
class crete_about extends \Elementor\Widget_Base
{
    ...
    public function get_title() {
        return esc_html__('Crete About', 'crete-core');
    }
    ...
    protected function render() {
        ...
        ?>
        <!--about section start-->
        <section class="cr-about-section overflow-hidden">
...
\Elementor\Plugin::instance()->widgets_manager->register(new \crete_about());
