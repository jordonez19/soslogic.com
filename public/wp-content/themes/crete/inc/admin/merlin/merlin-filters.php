...
function mayosis_merlin_import_file_urls() {
    return array(
     ...
     array(
            ...
            'import_preview_image_url' => CRETE_URL .'/assets/images/demos/1.jpg',
         ...
         array(
            ...
            'import_preview_image_url' => CRETE_URL .'/assets/images/demos/2.jpg',
            'preview_url' => 'https://teconce.com/crete-maindemo/',
            'import_notice' => __
            ('Before Setup Demo Please Install All Plugin Requireds.Intall Elementor as Page Builder.For Import You Need to wait 3-5 Mintues.', '@@textdomain'),
        ),
        ...
        array(
            ...
            'import_preview_image_url' => CRETE_URL .'/assets/images/demos/3.jpg',
            'preview_url' => 'https://teconce.com/crete-maindemo/',
            'import_notice' => __
            ('Before Setup Demo Please Install All Plugin Requireds.Intall Elementor as Page Builder.For Import You Need to wait 3-5 Mintues.', '@@textdomain'),
        ),
         ...
         array(
            ...
            'import_preview_image_url' => CRETE_URL .'/assets/images/demos/4.jpg',
            'preview_url' => 'https://teconce.com/crete-maindemo/',
            'import_notice' => __
            ('Before Setup Demo Please Install All Plugin Requireds.Intall Elementor as Page Builder.For Import You Need to wait 3-5 Mintues.', '@@textdomain'),
        ),
        ...
        array(
            ...
            'import_preview_image_url' => CRETE_URL .'/assets/images/demos/5.jpg',
            'preview_url' => 'https://teconce.com/crete-maindemo/',
            'import_notice' => __
            ('Before Setup Demo Please Install All Plugin Requireds.Intall Elementor as Page Builder.For Import You Need to wait 3-5 Mintues.', '@@textdomain'),
        ),
