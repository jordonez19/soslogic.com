...
$wizard = new Merlin(
	...
	$strings = array(
		'admin-menu'               => esc_html__( 'Setup Wizard', 'crete' ),
		...
		'ignore'                   => esc_html__( 'Disable this wizard', 'crete' ),
		...
		'license-header'         => esc_html__( 'Activate Theme', 'crete' ),
		'license-header2'         => esc_html__( 'Activate Your Theme', 'crete' ),
		/* translators: Theme Name */
		'license-header-success%s' => esc_html__( '%s is Activated', 'crete' ),
		/* translators: Theme Name */
		'license%s'                => esc_html__( 'Please add your Envato purchase code along with your email address to confirm the purchase.', 'crete' ),
		...
		/* translators: Theme Name */
		'welcome-header%s'         => esc_html__( 'Let\'s Get You Started', 'crete' ),
		'welcome-header-success%s' => esc_html__( 'Hi. Welcome back', 'crete' ),
		'welcome%s'                => esc_html__( 'Thanks for purchasing Crete! Start wizard to generate child theme, intstall plugins and import demo date.', 'crete' ),
		'welcome-success%s'        => esc_html__( 'You may have already run this theme setup wizard. If you would like to proceed anyway, click on the "Start" button below.', 'crete' ),

		'child-header'             => esc_html__( 'Install Child Theme', 'crete' ),
		...
		'plugins'                  => esc_html__( 'Let\'s install some essential WordPress plugins to get you started.', 'crete' ),
		...
		'plugins-action-link'      => esc_html__( 'View Plugins', 'crete' ),

		'import-header'            => esc_html__( 'Import Demo', 'crete' ),
		'import'                   => esc_html__( 'Let\'s import content to your website, to help you get familiar with the theme.', 'crete' ),
		'import-action-link'       => esc_html__( 'Advanced', 'crete' ),

		'ready-header'             => esc_html__( 'You\'re Ready!', 'crete' ),
		...
		'ready-link-1'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://teconce.ticksy.com/', esc_html__( 'Help center', 'crete' ) ),
		'ready-link-2'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://www.youtube.com/@teconce', esc_html__( 'Youtube', 'crete' ) ),
