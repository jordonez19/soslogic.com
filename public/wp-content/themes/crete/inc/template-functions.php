...
if(!function_exists('crete__wp_kses')):
	/**
	 * Allow basic tags
	 *
	 * @since 1.0.0
	 **/
	function crete__wp_kses($string = '')
	{
...
if(!function_exists('crete__implode_html_attributes')):
	/**
	 ...
	 * @return string
	 */
	function crete__implode_html_attributes( $raw_attributes ) {
...
if(!function_exists('crete__valid_url')):
	/**
	 * Checks for valid 200 response code
	 *
	 * @since 2.4.0
	 **/
	function crete__valid_url($url)
	{
