...
define('CRETE_CHILD_PATH', get_stylesheet_directory());
defined('CRETE_USER_LOGGED') or define('CRETE_USER_LOGGED', is_user_logged_in());
        ...
        public function includes_files(){
            ...
            if (!is_customize_preview()  && is_admin() ) {
               require_once (CRETE_PATH. '/inc/admin/merlin/vendor/autoload.php' );
                ...
                require_once (CRETE_PATH. '/inc/admin/merlin/merlin-filters.php' );
            }
